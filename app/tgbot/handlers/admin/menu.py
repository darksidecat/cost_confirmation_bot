...
admin_menu_dialog = Dialog(
    Window(
        ...
        Start(Const("User"), id="admin_menu", state=admin_menu.UserCategory.action),
        Start(
            Const("Department"),
            id="department",
            state=admin_menu.DepartmentCategory.action,
        ),
...
def register_admin_menu(dp: Router):
    dp.message.register(admin_menu_entry, any_state, commands=["is_admin"])
